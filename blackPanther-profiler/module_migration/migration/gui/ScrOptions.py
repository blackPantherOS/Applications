...
class Widget(QtGui.QWidget, ScreenWidget):
    ...
    def creator(self, sources):
        ...
        if sources.has_key("Wallpaper Path"):
            ...
            self.oldRadio.setToolTip(i18n("Copies your old wallpaper to blackPanther OS and sets it as new background image."))
        ...
        if sources.has_key("Firefox Profile Path") or sources.has_key("Favorites Path"):
            ...
            if sources.has_key("Firefox Profile Path"):
                ...
                self.fireFoxBookmarks.setToolTip(i18n("Copies your old Firefox bookmarks to Firefox under blackPanther OS."))
            ...
            if sources.has_key("Opera Profile Path"):
                ...
                self.operaBookmarks.setToolTip(i18n("Copies your old Opera bookmarks to Firefox under blackPanther OS."))
            ...
            if sources.has_key("Favorites Path"):
                ...
                self.IEBookmarks.setToolTip(i18n("Copies your old Internet Explorer favorites to Firefox under blackPanther OS."))
