...
import os, sys, dbus, glob
from PIL import Image

from module_gui.ScreenWidget import ScreenWidget
from module_gui.styleWidget import Ui_styleWidget
...
class Widget(QtGui.QWidget, ScreenWidget):
    ...
    def __init__(self, *args):
        ...
        lst2 = glob.glob1("./module_gui/styles", "*.style")

        for desktopFiles in lst2:
            parser = DesktopParser()
            parser.read("./module_gui/styles/" +str(desktopFiles))
            try:
            ...
            try:
                ...
                styleThumb = unicode(os.path.join("./module_gui/styles/",  parser.get_locale('Style', 'thumbnail','')))
                ...
                if not os.path.exists(color):
                    color = colorDir + "blackPantherBase.colors"
    ...
    def setDesktopType(self):
        ...
        print "DESKTOP INDEX",currentIndex
        if currentIndex == 0:
    ...
    def setStyle(self):
        ...
        print "SELECTED STYLE:", styleName
