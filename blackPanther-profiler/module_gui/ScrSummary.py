...
from module_gui.summaryWidget import Ui_summaryWidget
...
class Widget(QtGui.QWidget, ScreenWidget):
    ...
    def shown(self):
        ...
        content.append(item % ki18n("Selected clicking behaviour: <b>%s</b>").toString() % self.mouseSettings["summaryMessage"]["clickBehavior"].toString())
        content.append(end)
