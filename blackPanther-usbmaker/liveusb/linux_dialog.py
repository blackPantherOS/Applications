...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QtGui.QApplication.translate("Dialog", _("blackPanther USB-Maker"), None, QtGui.QApplication.UnicodeUTF8))
        self.startButton.setWhatsThis(QtGui.QApplication.translate("Dialog", _("This button will begin the USB creation process.  This entails optionally downloading a release (if an existing one wasn\'t selected),  extracting the ISO to the USB device, creating the persistent overlay, and installing the bootloader."), None, QtGui.QApplication.UnicodeUTF8))
        self.startButton.setText(QtGui.QApplication.translate("Dialog", _("Create USB OS"), None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.progressBar.setWhatsThis(QtGui.QApplication.translate("Dialog", _("This is the progress bar that will indicate how far along in the USB creation process you are"), None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.downloadGroup.setTitle(QtGui.QApplication.translate("Dialog", _("Download a ISO"), None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("Dialog", _("Use existing CD-image"), None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.overlayTitle.setTitle(QtGui.QApplication.translate("Dialog", _("Data && Changes Storage") + " (0 MB)", None, QtGui.QApplication.UnicodeUTF8))
